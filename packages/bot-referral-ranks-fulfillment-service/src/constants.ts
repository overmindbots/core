...
if (!process.env.GUILD_CHECK_INTERVAL) {
  throw new Error('Missing env variable GUILD_CHECK_INTERVAL');
}
...
export const GUILD_CHECK_INTERVAL = parseInt(
  process.env.GUILD_CHECK_INTERVAL,
  10
);
