...
if (!process.env.APP_REFERRAL_RANKS_INVITE_WRAPPER_TOTAL_SHARDS) {
  throw new Error(
    'Missing env variable APP_REFERRAL_RANKS_INVITE_WRAPPER_TOTAL_SHARDS'
  );
}
...
export const API_URL =
  process.env.APP_REFERRAL_RANKS_INVITE_WRAPPER_TOTAL_SHARDS;
