...
const totalShards = process.env.APP_REFERRAL_RANKS_INVITE_WRAPPER_TOTAL_SHARDS;
if (!totalShards) {
  throw new Error(
    `Environment variable missing: APP_REFERRAL_RANKS_INVITE_WRAPPER_TOTAL_SHARDS`
  );
}
